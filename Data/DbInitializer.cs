        ...
        public static void Initialize(IServiceProvider serviceProvider)
        {
            using (var context = new QLQuanDTContext(serviceProvider.GetRequiredService<DbContextOptions<QLQuanDTContext>>()))
            {
                ...
                var products = new Product[]
                {
                    ...
                    new Product{Id = 5, Name = "Điện thoại di động iPhone 15 Pro (512GB) - Chính hãng VN/A", Price = 36490000,IsStock = true, CatId = 1, Image = "iphone-15-pro-white-titanium-pure.png", Description = "iPhone 15 Pro sở hữu màn hình Super Retina XDR OLED 6,1 inch với tần số quét 120Hz và độ sáng lên tới 2000 nit. Bên cạnh đó, với con chip A17 Pro mạnh mẽ, máy mang đến hiệu năng cao cùng khả năng xử lý đa nhiệm tuyệt vời. Về camera, iPhone 15 Pro được trang bị cụm camera gồm 3 ống kính: 48MP cho góc rộng, 12MP cho tele và góc siêu rộng cao cấp.", Slug = "Dien-thoai-di-dong-iphone-15-pro-512GB-chinh-hang-VNA", IsFeatured = true, ScreenTech = "Màn hình Super Retina XDR, Tấm nền OLED, Dynamic Island, Công nghệ ProMotion với tốc độ làm mới thích ứng lên đến 120Hz, Màn hình Luôn Bật, Màn hình HDR, Tỷ lệ tương phản 2.000.000:1 (tiêu chuẩn), Màn hình True Tone, Màn hình có dải màu rộng (P3), Haptic Touch", Resolution = "1179 x 2556, Chính: 48MP, khẩu độ ƒ/1.78, Ultra Wide: 12MP, khẩu độ ƒ/2.2, Telephoto: 12MP, khẩu độ ƒ/2.8, Camera trước TrueDepth 12MP, khẩu độ ƒ/1.9", ScreenSize = "6.1\"", OperatingSystem = "iOS 17", Processor = "A17 Pro", InternalMemory = "512GB", Ram = "8GB", BatteryCapacity = "3.274 mAh"},
                    ...
                    new Product{Id = 7, Name = "Điện thoại di động iPhone 15 Pro (128GB) - Chính hãng VN/A", Price = 27490000,IsStock = true, CatId = 1, Image = "iphone-15-pro-blue-titanium-pure.png", Description = "iPhone 15 Pro sở hữu màn hình Super Retina XDR OLED 6,1 inch với tần số quét 120Hz và độ sáng lên tới 2000 nit. Bên cạnh đó, với con chip A17 Pro mạnh mẽ, máy mang đến hiệu năng cao cùng khả năng xử lý đa nhiệm tuyệt vời. Về camera, iPhone 15 Pro được trang bị cụm camera gồm 3 ống kính: 48MP cho góc rộng, 12MP cho tele và góc siêu rộng cao cấp.", Slug = "Dien-thoai-di-dong-iphone-15-pro-128GB-chinh-hang-VNA", IsFeatured = true, ScreenTech = "Màn hình Super Retina XDR, Tấm nền OLED, Dynamic Island, Công nghệ ProMotion với tốc độ làm mới thích ứng lên đến 120Hz, Màn hình Luôn Bật, Màn hình HDR, Tỷ lệ tương phản 2.000.000:1 (tiêu chuẩn), Màn hình True Tone, Màn hình có dải màu rộng (P3), Haptic Touch", Resolution = "1179 x 2556, Chính: 48MP, khẩu độ ƒ/1.78, Ultra Wide: 12MP, khẩu độ ƒ/2.2, Telephoto: 12MP, khẩu độ ƒ/2.8, Camera trước TrueDepth 12MP, khẩu độ ƒ/1.9", ScreenSize = " 6.1\"", OperatingSystem = " iOS 17", Processor = "A17 Pro", InternalMemory = "128GB", Ram = "8GB", BatteryCapacity = "3.274 mAh" },
                      new Product{Id = 8,
